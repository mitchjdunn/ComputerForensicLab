...
It is the manager's job to hire knowledgable forensic investigators with enough knowledge to cover the responsibi    lites of the lab. 
Training the staff to keep them up to date on protocols, investigative techniques, and updated accreditation stan    dards is a priority of the manager.
\newpage
\printbibliography
