...
Most labs strive to gain this accreditation but most do not meet the rigorous standards of the ACLD/LAB \cite{book}.
...
\paragraph{}
In order to keep evidence forensically sound, certain policies must be followed \cite{book}. 
...
\bibitem{website}
Andre Champagne: Planning a Digital Forensics Lab,
http://www.evidencemagazine.com/index.php?option=com\_content\&task=view\&id=2162\&Itemid=49
\bibitem{pdf}
authors
\textit{Forensic Science Laboratories: Handbook for Facility Planning, Design, Construction, and Relocation}

United States Department of Commerce, June 2013
\end{thebibliography}
\end{document}
